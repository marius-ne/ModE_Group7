"""Solve the MILP on a single price ratio and save the dispatch.

solve_and_save() is the reusable part: plot_milp_dispatch.py imports it to solve on demand
rather than requiring this script to be run first.

    python Marius/evaluation/run_milp_dispatch.py [ratio]
"""
