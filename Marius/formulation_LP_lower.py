...
def plot_dispatch_results(
    ...
    output_path: str = "Marius/visualization/dispatch_overview_LP_lower.png",
...
if __name__ == "__main__":
    ...
    dispatch.to_csv("Marius/results/dispatch_result_LP_lower.csv", index=False)
    print("Dispatch written to Marius/results/dispatch_result_LP_lower.csv")

    plot_dispatch_results(dispatch, gas_price=_cG, el_price=_cel, opex=opex, fontsize=18)
    print("Dispatch visualization written to Marius/visualization/dispatch_overview_LP_lower.png")
